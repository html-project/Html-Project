...
# html_project
A HTML and JavaScript program that runs browser Firefox and Chrome (access to Sadira or other programs that is written in Java, such as PyCharm).
...
If you are a Windows user and you want to use Chrome, please download at the offical website at [here](https://www.google.com/chro\roadme this program, we do it within like this to setup a local testing server, for example, you can do this:
